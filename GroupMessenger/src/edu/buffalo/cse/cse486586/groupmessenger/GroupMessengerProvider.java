...
/*    	sqlDB.execSQL("DROP TABLE IF EXISTS " + SQLLiteDBHelper.TABLE_NAME);
    	...
    	Log.v("Droped Table", SQLLiteDBHelper.TABLE_NAME);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        Cursor cursor = sqlDB.query(SQLLiteDBHelper.TABLE_NAME, projection, SQLLiteDBHelper.Key_column + "=?",selectArgs,null,null,sortOrder);
        if (cursor != null)
            cursor.moveToFirst();
